...
statusText = uicontrol(toolpurchPanel,'Style','text',...
                        'FontSize',12,...
                        'String','Staff/Student/Mentor/Teacher',...
                        'Units','normalized',...
                        'Position',[.25,.56,.5,.1]);
statusEdit = uicontrol(toolpurchPanel,'Style','edit',...
                        'Units','normalized',...
                        'FontSize',10,...
                        'Position',[.25,.53,.5,.08]);
...
addButton = uicontrol(addPanel,'Style','pushbutton',...
    ...
    function tool_callback(obj,eventdata)
        ...
        % OK Button
        tool_okButton = uicontrol(bottomrPanel,'Style','pushbutton',...
                                    'String','OK',...
                                    'FontSize',12,...
                                    'Units','normalized',...
                                    'Position',[.25,.2,.2,.6],...
                                    'Callback',{@toolOK_callback});
        ...
        function toolOK_callback(obj,eventdata)
           % ADD CODE HERE 
        end
    end
    ...
    function purchase_callback(obj,eventdata)
        ...
        % OK button
        purchase_OkButton = uicontrol(bottomrPanel,'Style','pushbutton',...
                                        'String','OK',...
                                        'FontSize',12,...
                                        'Units','normalized',...
                                        'Position',[.25,.2,.2,.6],...
                                        'Callback',{@purchaseOK_callback});
        ...
        function purchaseOK_callback(obj,eventdata)
            % ADD CODE HERE
        end
    end
    ...
    function add_callback(obj,eventdata)
        ...
        function addPerson_callback(obj,eventdata)
            ...
            person_statusEdit = uicontrol(addPerson_panel,'Style','edit',...
                                        'FontSize',12,...
                                        'Units','normalized',...
